...
Across four experiments, participants' confidence judgments about their own memory predicted their decisions to use externally saved information, providing direct evidence that cognitive offloading is associated with metacognitive evaluation of memory performance. A Bayesian computational model showed that beliefs about the performance boost from offloaded information are negatively coupled to evaluation of memory ability — the less you trust your memory, the more you offload.
