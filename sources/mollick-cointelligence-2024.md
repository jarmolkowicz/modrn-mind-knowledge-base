...
- Outside frontier: 19 percentage points worse — consultants trusted AI on tasks it couldn't handle
- Most participants simply pasted questions and accepted AI output without editing
- Source: Dell'Acqua et al. (2023), co-authored by Mollick

### Falling Asleep at the Wheel (Dell'Acqua separate study, N=181)
- Higher-quality AI made recruiters *worse* — they spent less time, followed AI blindly
...
### Expertise Paradox
- AI is best leveraged by those who already have domain expertise
- GPT-4 outperforms 1st/2nd-year medical students on clinical reasoning exams
- Temptation to skip foundational learning, but expertise is what enables evaluation of AI output
- Working memory limitations mean you need facts in long-term memory to solve novel problems
...
- **Delegated Tasks** — AI generates, human checks
- **Automated Tasks** — AI handles without human review (small category, for now)
- **Centaur Tasks** — clear division of labor between human and AI
- **Cyborg Tasks** — continuous interweaving of human and AI throughout workflow

## Supports
- [[jagged-frontier]] - Mollick co-authored the foundational BCG/Harvard study
- [[novice-vulnerability]] - leveling effect evidence; apprenticeship crisis
- [[execution-commoditization]] - task taxonomy shows execution shifting to AI
- [[calibration]] - "Be the human in the loop" as calibration principle
- [[strategic-alternation]] - Centaur/Cyborg patterns as alternation modes
- [[confidence-competence-gap]] - "falling asleep at the wheel" mechanism
- [[cognitive-offloading]] - systematic treatment of delegation decisions