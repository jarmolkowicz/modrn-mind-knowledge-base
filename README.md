...
- `concepts/` — 53 atomic named phenomena: cognitive surrender, capacity erosion, performance paradox, belief offloading, and more
...
- `sources/` — 60 curated sources (papers, books, articles) with key insights, verbatim passages, and full citations
...
- **Browse it yourself** — Start with [index.md](index.md) for a scannable catalog of all 124 entries. From there, follow what catches your eye. `concepts/cognitive-debt.md` is a good starting concept; `methods/scan.md` and `methods/think-first.md` are strong methods to begin with.
