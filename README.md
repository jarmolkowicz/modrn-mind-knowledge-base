...
- `concepts/` — 52 atomic named phenomena: cognitive surrender, capacity erosion, performance paradox, belief offloading, and more
- `methods/` — 11 structured guides: descriptive models (Tri-System Theory, SCAN, Complementarity, Modern Mind) and prescriptive practices (think-first, calibration, strategic alternation, modulation)
- `sources/` — 58 curated sources (papers, books, articles) with key insights, verbatim passages, and full citations
...
- **Browse it yourself** — Start with [index.md](index.md) for a scannable catalog of all 121 entries. From there, follow what catches your eye. `concepts/cognitive-debt.md` is a good starting concept; `methods/scan.md` and `methods/think-first.md` are strong methods to begin with.
