...
- `sources/` — 61 curated sources (papers, books, articles) with key insights, verbatim passages, and full citations
...
- **Browse it yourself** — Start with [index.md](index.md) for a scannable catalog of all 125 entries. From there, follow what catches your eye. `concepts/cognitive-debt.md` is a good starting concept; `methods/scan.md` and `methods/think-first.md` are strong methods to begin with.
