...
The screener writes its results to `raw/processing/[source-slug]/SCREENING.md` (creating the directory if needed; the researcher uses the same directory for drafts later).
