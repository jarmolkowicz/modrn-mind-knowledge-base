---
description: Distill an approved source from raw/inbox/ into KB drafts (concepts, methods, source distillation). Outputs to workspace/processing/ for human review.
---
